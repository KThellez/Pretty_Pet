...
public class Suppliers extends javax.swing.JInternalFrame {
    ...
    public JTable getTablaSupplier() {
        return tablaSupplier;
    }

    public void setTablaSupplier(JTable tablaSupplier) {
        this.tablaSupplier = tablaSupplier;
    }
    ...
    public void setTxtSupplierID(JTextField txtSupplierID) {
    ...
    private void initComponents() {
        ...
        tablaSupplier = new javax.swing.JTable();
        ...
        tablaSupplier.setBackground(new java.awt.Color(248, 147, 31));
        tablaSupplier.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tablaSupplier.setForeground(new java.awt.Color(20, 35, 61));
        tablaSupplier.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Supplier ID", "Name", "Description", "Amount", "Price", "Stock"
            }
        ));
        tablaSupplier.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaSupplierMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaSupplier);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtSupplierID, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tablaSupplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaSupplierMouseClicked
     int fila = tablaSupplier.rowAtPoint(evt.getPoint());
       
        txtSupplierID.setText((String) tablaSupplier.getValueAt(fila, 0));
        txtName.setText((String) tablaSupplier.getValueAt(fila, 1));
        txtLastName.setText((String) tablaSupplier.getValueAt(fila, 2));
        txtPhone.setText((String) tablaSupplier.getValueAt(fila, 3));
        txtAddress.setText((String) tablaSupplier.getValueAt(fila, 4));
        txtEmailAddress.setText((String) tablaSupplier.getValueAt(fila, 5));       
    }//GEN-LAST:event_tablaSupplierMouseClicked
    ...
    private javax.swing.JTable tablaSupplier;
